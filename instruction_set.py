...
OR_8 = MATH_BASE_8 + 8 
AND_8 = MATH_BASE_8 + 9 
NOT_8 = MATH_BASE_8 + 10 ## Not sure how NOT, SHL, and SHR are going to work, perhaps the shift ops use one register as a carry register. Perhaps NOT also does an XOR of the two regs and puts the result in the one NOT doesn't use.
